...
const stack = [
  ...
  { name: "Auth.js", icon: <Authjs className="w-4 h-4" /> },
  { name: "shadcn/ui", icon: <Shadcnui className="w-4 h-4" /> },
  { name: "Tailwind", icon: <TailwindCSS className="w-4 h-4" /> },
  { name: "TanStack", icon: <TanStack className="w-4 h-4" /> },
];
